...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Security/SimulatedAuthSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\Security\\SimulatedAuthSubscriber')] fn () => ($container->privates['App\\Security\\SimulatedAuthSubscriber'] ??= new \App\Security\SimulatedAuthSubscriber()), 'onRequest'], 255);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\OrderController', 'App\\Controller\\ProductController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
